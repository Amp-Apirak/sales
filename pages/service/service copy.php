...
$filterChannel    = $_GET['channel']         ?? ''; // เพิ่ม Channel filter
...
$channelOptions      = distinctOptions($condb, 'channel', $visibility['clause'], $visibility['params']); // เพิ่ม Channel options
...
$mapFilters = [
    ...
    'channel'          => $filterChannel, // เพิ่ม Channel filter
];
