...
$show_supplier_info = ($is_creator || $is_executive || ($is_sale_supervisor_or_seller && $is_same_team));
$show_edit_delete = ($is_creator || $is_executive || ($is_sale_supervisor_or_seller && $is_same_team));
?>
...
<style>
    ...
    /* ปรับให้เนื้อหาหลักไม่ทับ Footer */
    .content-wrapper {
        margin-bottom: 60px;
        /* ปรับระยะห่างจาก Footer */
    }
</style>