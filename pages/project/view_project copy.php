...
try {
    ...
    try {
        ...
        switch ($role) {
            case 'Executive':
                $hasAccess = true; // ผู้บริหารเข้าถึงได้ทุกโครงการ
                break;
            case 'Sale Supervisor':
                // หัวหน้าทีมขายเข้าถึงได้เฉพาะ:
                // - โครงการในทีมของตัวเอง หรือ
                // - เป็นสมาชิกในโครงการนั้น
                $hasAccess = ($user_team_id == $project['creator_team_id'] || $project['has_access']);
                break;
            case 'Seller':
            case 'Engineer':
                // พนักงานขายและวิศวกรเข้าถึงได้เฉพาะ:
                // - เป็นผู้สร้างโครงการ หรือ
                // - เป็นสมาชิกในโครงการนั้น
